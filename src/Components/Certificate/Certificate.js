...
const Certificate = () => {
  return (
    <>
      <div className="flex flex-row justify-between items-center bg-[#F0FFF7] px-28 py-16">
        <div className="w-[828px] h-[585.36px]">
          <img src={Img1} className="w-full h-full object-fit" />
        </div>
        <div className="flex flex-col gap-6 w-[47%]">
          <p className="text-[44px] text-[#000000] font-poppins font-bold">
            {" "}
            <span className="text-[#1DBF73]"> Certification </span> By The
            N.S.D.C
          </p>
          <p className="text-[#000000] text-[24px] font-Nunito Sans text-justify leading-10">
